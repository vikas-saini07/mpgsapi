...
<script type="text/javascript"> 
    var sessionId = "SESSION0002416754193J77514782I5";
    var sessionVersion = "4b78237501";
    var successIndicator = "a700d73e6ac4492c";
    var orderId = "ABC11112123";
var x = Math.floor((Math.random() * 100000) + 1000); 
var n = x.toString(); 
...
More test cards: <a href="https://test-gateway.mastercar.com/api/documentation/integrationGuidelines/supportedFeatures/testAndGoLive.html?locale=en_US" target="_blank">Click here<a/><br>
China Union Pay: 
